...
getwd()
setwd("C:/Users/user/Downloads/MyProject")
...
tryCatch({
  twitter_data <- read_csv("data/twitter/tweets_20250420_120446.csv")
  reddit_data <- read_csv("data/reddit/reddit_posts_20250420_125024.csv")
}, error = function(e) {
